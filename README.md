Учебный проект "Новостной сайт", Java Servlets + JSP + PostgeSQL. Сторонние библиотеки: postgresql-42.7.3. В папке SQL миграции для создания схемы и наполнения бд.
Функционал:
